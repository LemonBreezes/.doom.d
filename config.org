...
- [[#personal-modules][Personal modules]]
  ...
  - [[#global-doom-leader-key][Global doom leader key]]
  ...
  - [[#preview-latex-fragments-everywhere][Preview LaTeX fragments everywhere]]
  - [[#eww][EWW]]
...
#+END_SRC
*** COMMENT Auto-correct more typos due Qukeys-related typos
...
#+END_SRC
** Preview LaTeX fragments everywhere
:PROPERTIES:
:CREATED_TIME: [2020-02-06 Thu 11:42]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
(use-package! texfrag
  :defer-incrementally t
...
#+END_SRC
*** Increase size of LaTeX previews from texfrag in EWW
:PROPERTIES:
:CREATED_TIME: [2020-02-06 Thu 13:27]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
(after! eww
  (add-hook! 'eww-mode-hook
    (text-scale-set 2)))
#+END_SRC
*** COMMENT EWW in its own workspace
:PROPERTIES:
:CREATED_TIME: [2020-02-07 Fri 12:22]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
(defvar +eww-workspace-name "*eww*")
(defvar +eww--old-wconf nil)

(add-hook 'eww-mode-hook #'+eww-init-h)

(defun +eww ()
  (interactive)
  (if (featurep! :ui workspaces)
      (+workspace-switch +eww-workspace-name t)
    (setq +eww--old-wconf (current-window-configuration))
...
(defun +eww-init-h ()
  (add-hook 'kill-buffer-hook #'+eww-kill-eww-h nil t))

(defun +eww-kill-eww-h ()
  (cond
   ((and (featurep! :ui workspaces) (+workspace-exists-p +eww-workspace-name))
    (+workspace/delete +eww-workspace-name))

   (+eww--old-wconf
    (set-window-configuration +eww--old-wconf)
    (setq +eww--old-wconf nil))))

(defun +eww-workspace-other-or-quit ()
  (interactive)
  (if (equal (+workspace-current-name)
             +eww-workspace-name)
      (progn (+workspace/other)
             (kill-buffer "*eww*"))
    (+popup/close)))

(map! (:leader
        :desc "Emacs Web Wowser" "ab" #'+eww)
      (:after eww
        (:map eww-mode-map
          :n "q" #'+eww-workspace-other-or-quit)))
#+END_SRC
*** Language detection for EWW
:PROPERTIES:
:CREATED_TIME: [2020-02-07 Fri 14:08]
:END:
#+begin_src emacs-lisp :tangle yes
(after! eww
  (require 'cl-lib)
...
#+END_SRC
*** COMMENT Company Org LaTeX math
:PROPERTIES:
...
** Org
*** Sync Org agenda to ICS file
:PROPERTIES:
:CREATED_TIME: [2020-02-07 Fri 10:15]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
(after! org
...
*** Org query language
:PROPERTIES:
:CREATED_TIME: [2020-02-06 Thu 22:06]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
(use-package! org-ql
  :defer-incrementally t
...
:PROPERTIES:
:CREATED_TIME: [2020-02-03 Mon 09:05]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
(after! org-journal
...
#+END_SRC
**** COMMENT Toggle LaTeX fragments automatically with cursor
:PROPERTIES:
:CREATED_TIME: [2020-02-06 Thu 11:06]
:END:
#+BEGIN_SRC emacs-lisp :tangle yes
